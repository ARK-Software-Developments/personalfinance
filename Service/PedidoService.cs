...
namespace PersonalFinance.Service
{
    public class PedidoService
    {
        ...
        public async Task<PedidosResponse> Obtener()
        {
            PedidosResponse pedidosResponse = new();

            // Hacer la solicitud GET a la API
            HttpResponseMessage response = await this._httpClient.GetAsync(_urlPedido);
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                pedidosResponse.Pedidos = (List<Pedido>)pedidos;
